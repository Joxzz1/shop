...
<body>
    ...
    <center>
        ...
        <small class="text-white mb-1 "></i>&nbsp; Create By SongKran & Overdrive-C.<a href="https://discord.gg/s697cmDN" class="text-white mb-1"><i class="fa-solid fa-triangle-exclamation fa-fade"></i>&nbsp;ติดต่อเจ้าของร้านไม่ได้ / แจ้งปัญหาร้านค้าโกง</a></small>
    </center>

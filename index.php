                    ...
                    <li class="nav-item align-self-center ms-lg-3">
                        ...
                        <li class="nav-item align-self-center ms-lg-3">
                            <a class="nav-link underline-active align-self-center text-main" aria-current="page"
                                href="https://www.facebook.com/profile.php?id=100063900591544"><img src="assets/icon/call-center.png" width="20"
    ...
    <footer class="bg-white shadow pt-3">
        <div class="container">
            ...
            <div class="container-fluid pt-3 pb-3">
                <center>
                    <p class="text-dark mb-1 "><strong><i class="fa-regular fa-copyright"></i>&nbsp; 2024 <?php echo $config['name']; ?></strong></p>
                    <small class="text-dark mb-1 "></i>&nbsp; JUTI SHOP <a href="https://discord.gg/chxuT9zC" class="text-dark mb-1"><i class="fa-solid fa-triangle-exclamation fa-fade"></i>&nbsp;ติดต่อเจ้าของร้านไม่ได้ </a></small>
                </center>
            </div>
        </div>
    </footer>
